...
// rogerwangcs-react-scripts start
function rogerwangcsLog() {
  console.log(chalk.blueBright('Custom create-react-app for rogerwangcs'));
}
// rogerwangcs-react-scripts end
